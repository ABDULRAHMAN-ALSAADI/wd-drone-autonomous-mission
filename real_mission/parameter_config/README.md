...
| `payload.blue_payload_pwm` | Selector position for the blue payload, used on the red triangle. | `1700` for the tested mechanism. |
| `payload.red_payload_pwm` | Selector position for the red payload, used on the blue hexagon. | `1300` for the tested mechanism. |
...
```text
red triangle  -> blue payload -> 1700 PWM -> wait 3 s -> 1500 PWM
blue hexagon  -> red payload  -> 1300 PWM -> wait 3 s -> 1500 PWM
```
