...
python -m py_compile tools/mavlink_bench.py tools/pi_camera_check.py src/wd_drone/*.py target_mission_v2/control.py target_mission_v2/mission_controller.py target_mission_v2/vision.py target_mission_v2/camera_sources.py
